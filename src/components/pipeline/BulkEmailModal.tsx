...
import { Input as CustomInstructionsInput } from '@/components/ui/input';
...
export function BulkEmailModal({ open, onOpenChange, investors }: BulkEmailModalProps) {
  ...
  const handleGenerateWithAI = async () => {
    ...
    try {
      ...
      setBody(stripHtml(data.body || body));
      toast.success('Email generated by AI — personalization placeholders preserved');
    } catch (error) {
          ...
          <div className="flex-1 overflow-y-auto pr-1 space-y-4 pb-2">
            ...
            <div className="rounded-lg border border-primary/20 bg-primary/5 p-4 space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Use placeholders like <code className="bg-muted px-1 rounded">{'{{name}}'}</code> in the generated email for personalization per recipient.
              </p>
            </div>
